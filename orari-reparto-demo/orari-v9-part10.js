...
function applyPdv1OperationalProfile(out){
  ...
  out.forEach((day,index)=>{
    ...
    pdv1AddMorningCoverage(day,index,index===5?Math.max(5,Number(ops.gastro.morningCounts[index])||0):Number(ops.gastro.morningCounts[index])||0);
